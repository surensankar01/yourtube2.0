        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1 space-y-2">
            <h1 className="text-2xl md:text-4xl font-bold flex items-center gap-3">
              {channel?.channelname}
              {channel?.planType && channel.planType !== "free" && (
                <span className="inline-flex items-center rounded-full bg-red-100 px-3 py-0.5 text-xs font-semibold text-red-800 capitalize">
                  {channel.planType} Member
                </span>
              )}
            </h1>
